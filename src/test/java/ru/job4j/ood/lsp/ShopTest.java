...
class ShopTest {
    ...
    public void checkDiscount() {
        ...
        Food product = new Bread("White", LocalDate.now().plusDays(2), LocalDate.now().minusDays(10), 80.0, 0.5);
    ...
    public void checkByDate() {
        AbstractStore shop = new Shop();
        Food product = new Bread("White", LocalDate.now().plusDays(10), LocalDate.now().minusDays(5), 80.0, 0.2);
        assertTrue(shop.supports(product));
